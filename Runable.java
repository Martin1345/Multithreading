...
public class Runnable {//Klasse zur Demonstration von Runnable in Java
    ...
    public static void main(String[] args) {
        ...
        Thread thread1 = new Thread(aufgabe1);// Erzeugung eines Threads mit der Aufgabe1
        Thread thread2 = new Thread(aufgabe2);// Erzeugung eines Threads mit der Aufgabe2

        thread1.start();// Start des ersten Threads
        thread2.start();// Start des zweiten Threads

        System.out.println(" Beide Threads wurden gestartet!");// Ausgabe an den Nutzuer, sobald beide Threads gestartet wurden
    }
}
